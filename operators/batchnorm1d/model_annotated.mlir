...
module {
  func.func @main(%arg0: tensor<3xf32> {secret.secret}, %arg1: tensor<3xf32> {secret.secret}, %arg2: tensor<i64> {secret.secret}, %arg3: tensor<1x3x16xf32> {secret.secret}) -> tensor<1x3x16xf32> {
