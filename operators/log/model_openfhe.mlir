...
module attributes {backend.openfhe, scheme.actual_slot_count = 16384 : i64, scheme.ckks, scheme.requested_slot_count = 1024 : i64} {
  func.func @main(%cc: !cc, %arg0: tensor<1x!ct> {tensor_ext.original_type = #original_type}) -> (tensor<1x!ct> {tensor_ext.original_type = #original_type}) {
    %cst = arith.constant dense<0.68965518474578857> : tensor<1024xf64>
    %c0 = arith.constant 0 : index
    %cst_0 = arith.constant dense<1.0689655542373657> : tensor<1024xf64>
    %cst_1 = arith.constant dense<1.0673929452896118> : tensor<1024xf64>
    %cst_2 = arith.constant dense<0.63315165042877197> : tensor<1024xf64>
    %cst_3 = arith.constant dense<-0.48060953617095947> : tensor<1024xf64>
    %cst_4 = arith.constant dense<2.000000e+00> : tensor<1024xf64>
    %cst_5 = arith.constant dense<1.000000e+00> : tensor<1024xf64>
    %cst_6 = arith.constant dense<0.047107648104429245> : tensor<1024xf64>
