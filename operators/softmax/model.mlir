...
module {
  func.func @main(%arg0: tensor<1x64xf32>) -> tensor<1x64xf32> {
    ...
    %4:2 = linalg.generic {indexing_maps = [#map, #map1, #map1], iterator_types = ["parallel", "reduction"]} ins(%arg0 : tensor<1x64xf32>) outs(%3, %1 : tensor<1xf32>, tensor<1xi64>) {
    ...
    %7 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel"]} ins(%6 : tensor<1x64xf32>) outs(%5 : tensor<1x64xf32>) {
    ^bb0(%in: f32, %out: f32):
      %12 = math.exp %in : f32
      linalg.yield %12 : f32
    } -> tensor<1x64xf32>
    ...
    %11 = linalg.generic {indexing_maps = [#map, #map2, #map], iterator_types = ["parallel", "parallel"]} ins(%7, %10 : tensor<1x64xf32>, tensor<1x1xf32>) outs(%5 : tensor<1x64xf32>) {
    ^bb0(%in: f32, %in_1: f32, %out: f32):
